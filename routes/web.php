...
Route::middleware(['role:super_admin'])->group(function() {
    ...
    Route::post('/create/pricing' , [SuperAdminController::class, 'create_pricing'])->name('superadmin.create.pricing');
    // Route::get('/store/pricing', [SuperAdminController::class, 'store'])->name('superadmin.storepricing');

    // Washing Data
    Route::get('/washing_data', [SuperAdminController::class,'Washing_data'])->name('superadmin.washingdata');
    Route::get('/forcedelete/data/{id}', [SuperAdminController::class, 'forcedelete_data_plans'])->name('superadmin.forcedeletedata');
