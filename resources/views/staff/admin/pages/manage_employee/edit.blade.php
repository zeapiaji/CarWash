    ...
    <div class="col-lg-8 pe-lg-2">
      <div class="card mb-3">
        ...
        <div class="card-body bg-light">
          <form action="/update/employe/{{ $data->id }}" method="POST" class="row g-3">
            @csrf
            <div class="col-lg-6">
            ...
            {{--  <div class="col-lg-6">
                ...
                <div class="mt-3">
                    ...
                    <input class="form-control" id="type" name="type" type="text" value="{{$data->car->type}}" />
                </div>
                <div class="mt-3">
                    <label class="form-label" for="number_plate">Plat Nomor</label>
                    <input class="form-control" id="number_plate" name="number_plate" type="text" value="{{$data->car->number_plate}}" />
                </div>
            </div>  --}}
            <div class="col-lg-12">
                <label class="form-label" for="address">Alamat</label>
                <textarea class="form-control" id="address" name="address" cols="30" rows="3">{{$data->address}}</textarea>
            </div>
