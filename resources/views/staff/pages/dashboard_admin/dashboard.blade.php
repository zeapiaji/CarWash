            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center">
                  <h5 class="mb-0">Proses cuci berlangsung</h5><a class="btn btn-link btn-sm px-0" href="#!">Report<span class="fas fa-chevron-right ms-1 fs--2"> </span></a>
                </div>
                <div class="card-body">
          ...
          <div class="row g-3 mb-3">
                    ...
                    <div class="card-header pb-0">
                      <div class="row flex-between-center g-card">
                        ...
                        <div class="col-auto d-flex">
                          ...
                          <div class="btn btn-sm btn-text d-flex align-items-center p-0 shadow-none" id="echart-bar-report-for-this-week-option-2"><span class="fas fa-circle text-300 fs--2 me-1"></span><span class="text">Minngu lalu</span></div>
                        </div>
                      </div>
                    </div>
           ...
           <div class="row">
            <div class="col d-none d-sm-block">
                <span class="fas fa-users text-primary" style="color: #344050; font-size:20px;"></span>
                <h4 class="d-none d-sm-inline-block fw-bolder  text-primary ms-1">Pegawai</h4>
            </div>
            <div class="col-auto d-none d-sm-block">
                <h6 class="d-none d-sm-inline-block ms-1">Total Pegawai</h6>
                <span class="fw-bolder mx-1" style="font-size:20px">|</span>
                <h6 class="d-none d-sm-inline-block" data-countup='{"endValue":{{$totalCashier}}}'>0</h6>
            </div>
        </div>
    </div>
</div>  
                ...
                <div class="card-body p-0">
                  <div class="scrollbar">
                    ...
                    @foreach ($data as $item)
                          ...
                          <td class="align-middle text-center"><small class="badge fw-semi-bold rounded-pill badge-soft-danger">{{$item->phone}}</small></td>
                          <td class="align-middle text-center"><small class="badge fw-semi-bold rounded-pill badge-soft-primary">{{$item ->email}}</small>
                            
                          </td>
                          <td class="align-middle">
                            <div class="row g-2 justify-content-end">
                              <div class="col-auto"><small class="badge fw-semi-bold rounded-pill badge-soft-success">{{$item->gender -> name}}</small>
