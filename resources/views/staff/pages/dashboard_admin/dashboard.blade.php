...
@endforeach --}}
                @foreach ($history[0]->revisionHistory as $item)
                <div class="row g-3 timeline timeline-primary timeline-past pb-card">
                    ...
                    <div class="col">
                        <div class="row gx-0 border-bottom pb-card">
                            <div class="col">
                                <h6 class="text-800 mb-1">{{ $item->userResponsible()->name }} {{ $item->oldValue()? 'Selesai mencuci di doorsmeer '.$item->revisionable_id : ''}} {{ $item->newValue()? 'Mencuci di doorsmeer '.$item->revisionable_id : ''}}</h6>
                            </div>
                            <div class="col-auto">
            ...
            <div class="card-body scrollbar recent-activity-body-height ps-2">
                ...
                <div class="row g-3 timeline timeline-primary timeline-past pb-card">
                    ...
                    <div class="col">
                        <div class="row gx-0 border-bottom pb-card">
                            <div class="col">
                                <h6 class="text-800 mb-1">{{ $item->userResponsible()->name }} {{ $item->oldValue()? 'Menerima transaksi dari doorsmeer '.$item->revisionable_id : ''}} </h6>
                            </div>
                            <div class="col-auto">
                                <p class="fs--2 text-500 mb-0">{{$item->created_at->format('M-d H:i:s')}}</p>
                            </div>
