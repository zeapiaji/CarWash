            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden" id="customers-table">
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="plan_id">tipe</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="feature">fitur</th>
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="email align-middle py-2">{{$item->plan_id}}</td>
                        <td class="email align-middle py-2">{{$item->feature}}</td>
